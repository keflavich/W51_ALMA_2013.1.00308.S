...
Our observations contradict some of the assumptions in this scenario.
...
that these stars are only effective at dense gas heating \emph{before} they
ignite Lyman continuum emission and blow out cavities, and afterward they are
merely uninteractive witnesses to continued collapse \citep{Peters2010c}.
...
manner and fell into a common central potential \citep[e.g., the `conveyor belt'
scenario for cluster formation,][]{Walker2016a}, they would have had little
...
the total space velocities of the \hii regions and the dense gas can distinguish
