...
moderately-excited \methanol lines for each HMYSO core in Figures
...
to show the general location of the outflows.}
...
range 48-68 \kms.  See \ref{fig:kinematicse2}.}
...
range 48-70 \kms.  See \ref{fig:kinematicse2}.}
...
toroids'' or ``Keplerian-like'' rotation curves around HMYSOs
...
fail to detect high-velocity features associated with a disk.
...
We do not repeat the exercise for e8 and north
because their outflow directions are far more ambiguous, though they show
similar features at all plausible position angles.
