...
\begin{abstract}
    ...
    these sources.  The data do not show any clear signs of disks or rotating
    ...
    centimeter continuum emission from these sources, implies that they are not
    on the main sequence while they accrete the majority of their mass;
    instead, they may be bloated and cool.
...
lower-mass fragments \citep{Peters2010a}, though other simulations suggest
...
approximation of the true mass profile (though it is likely a lower limit on
...
the range 1-2.  However, the systematic uncertainties on the shape of the
profile are dramatic, including uncertainties in the gas temperature profile
and the overall dust emission profile because of spatial filtering, so we do
not examine these profiles quantitatively.
...
these outflows (Figure \ref{fig:ch3ohvscont}.  In e2e, the spatial locations of
both the blue and red lobe of the CO outflow are redshifted in the dense gas,
while the rest of the core is blueshifted.  The outflow axis shows some of the
lowest velocity dispersion in the e2e core, suggesting that the outflow is not
responsible for driving the observed velocity dispersion.
...
by of observational limitations rather than a lack of infall motion.
...
many overlapping coherent flows along each line of sight.  For the rest of this
section, we assume that the gas flows are predominantly coherent and that
thermal support is a relevant physical process.
...
polarization to get the field direction.  \citet{Etoka2012a} used OH masers to
measure the field strength, obtaining 2-7 mG.  \citet{Koch2012a} showed that
even with this high field strength, the central core at $r<1\arcsec$ is
magnetically supercritical, i.e., dominated by self-gravity.  The presence of
such strong magnetic fields throughout the hot cores may suppress fragmentation
and slow down accretion, though in simulations magnetic fields have little
effect on already-collapsing regions \citep{Myers2013b,Krumholz2016a}.
