...
effect on the dense gas temperature.  This latter possibility seems likely
and may even be possible to confirm by measuring stellar kinematics in the
forming clusters. 
...
The `enforced isolation' scenario is, on face, incompatible with the `cooperative
accretion' scenario.  We do not have the evidence needed to distinguish between
these, but we can suggest an observational test: if the cluster of \hchii
...
conditions for the current generation of high-mass star formation.  
