...
the total mass is $M\approx1400 (T / 100 \mathrm{K})^{-1}$ \msun.  The mass
...
{Spectra of the \methanol lines toward a selected pixel just outside of the
e2e core.  The red curves show the LTE model fitted from a rotational diagram
as shown in Figure \ref{fig:ch3ohe2rot}.  }
