...
\abstract{
    ...
    field.  We show new evidence that, during the process of forming, these
    high-mass stars heat a large volume (and correspondingly large mass) of
    gas, preventing it from fragmenting, and therefore keep a large reservoir
    available to feed from.  By contrast, more mature massive stars that
    illuminate compact \hii regions have little effect on ther surrounding
    dense gas, hinting that these sources have completed most or all of their
    accretion.  These warm cores are presently stable against Jeans
