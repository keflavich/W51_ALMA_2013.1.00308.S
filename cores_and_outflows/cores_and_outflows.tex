...
\abstract{
    ...
    therefore keep a large reservoir available to feed from.
    By contrast, more
    ...
    These warm cores are presently stable against Jeans fragmentation, but
    at their current density and lower temperature, they would not have been,
    so they must have been assembled from a larger volume of gas.
...
univeral) distribution \citep{Bastian2010a},  massive stars O-stars (with $M>50
\msun$) almost always form in a clustered fashion \citep[in proto-clusters or
proto-associations][]{deWit04a,deWit05a,Parker2007a}. %bressert2012? dewit todo
...
mJy/beam.  Deeper cleaning was attempted, but lead to instabilities.  The
combined image has a central frequency of about 226.6 GHz assuming a flat
spectrum source; a steep-spectrum source, with $\alpha=4$, would have a central
frequency closer to 227 GHz, a difference that is negligible for all further
analysis.
...
temperature for each species \citep{Garrod2006a}, though some species
may appear at temperatures above or below their sublimation temperature
...
\todo{We hope to explore this possibility further in a
subsequent paper.}
...
range limitations, but the higher Jeans mass
noted above suggests that any fragments that do exist should be more massive
