...
blackbody, is $L = 4\pi r^2 \sigma_{sb} T^4 = 2.4\ee{4} \lsun$.  If we assume
that $T_{dust} = T_{peak}$ and that the dust is optically thin, we derive a dust
mass $M_{dust}\sim20$ \msun.  However, this final mass is not a strict limit in
...
hotter and therefore lower in mass.
...
\todo{Is this worth expanding upon or is it better to defer to another work?}

\Figure{figures/W51e2_ch3oh_hnco_continuum_aplpy_kucontours.pdf}
{Image of \methanol 8-... (red), HCNO 10-... (green), and continuum
(blue) toward W51e2.  The contours show Ku-band radio continuum
