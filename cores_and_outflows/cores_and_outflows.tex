...
The dominant outflow in W51, which was previously detected by the SMA \citep{}, comes from 
the source e2e.  Its morphology is peculiar: both the red- and blue-shifted ends show a `notch'
effect, turning 90 degrees at their ends.  This is particularly strange because the right angle
turns are in the same direction, not the opposite as would be expected if the whole system were
rotating in the plane of the sky.  To the northwest, the notch 

TODO: discuss the velocity structure of this flow.
