...
The classification is a broad guideline for further analysis.  It is not fully
reliable.  For example, ALMAmm14 is classified as a `starless core candidate'
even though it exhibits classic hot-core chemical signatures.
\todo{This is probably because of the way I extracted aperture-averaged spectra.
\texttt{peak\_spectral\_extraction.py} is now getting more appropriate spectra...}
