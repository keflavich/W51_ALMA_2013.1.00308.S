...
absent in the centimeter continuum, so it is most likely dust emission.  The
...
\Figure{figures/e5_bubble.png}
{The bubble around source e5.
}{fig:e5bubble}{1}{10cm}
...
\ref{fig:chemmaps}).  These features are elongated in the direction of the
outflow, but have significant extend orthogonal to the outflow, spanning
$9500\times6600$ AU.  They are prominent in \methanol, OCS, and CH3OCH3, weak
...
\Figure{figures/chemical_m0_slabs_e2e8.png}
{Moment 0 maps of the e2 region in 25 different species over the range 51 to 60
...
surroundings.  HC$_3$N traces the e2 outflow.
}{fig:chemmaps}{1}{18cm}
