...
core is nontrivial: if the core has a profile $\kappa_\rho < 3$, the observed
mass will  exceed the spherical shell mass, while if $\kappa_\rho > 3$,
it will be an underestimate.}
% The Jeans length
