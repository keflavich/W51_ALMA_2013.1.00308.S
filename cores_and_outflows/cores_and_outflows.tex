...
detected beam is optically thick, are 1.6\ee{4} and 3.9\ee{4} \lsun,
respectively.
...
\todo{Is it worth going through the process of preventing/halting fragmentation
by heating?  Should probably compute density profile, temperature profile, resulting
jeans mass profile}
