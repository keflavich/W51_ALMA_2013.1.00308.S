...
species CO and \formaldehyde.  Given the density necessitated by any continuum
detection for a spherical source $n>10^{7.5}$ \percc for a 1.6 mJy source,
it is unlikely that the species are merely subthermally excited.  More likely,
the underyling emission source is very compact, optically thick, and/or cold.
