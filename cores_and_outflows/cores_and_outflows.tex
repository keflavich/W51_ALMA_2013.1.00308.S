...
\emph{lower limit} luminosities for the three most massive cores correspond
to early B-type photospheres.  Such stars should emit enough radiation to ignite
luminous compact \hii regions, $Q_{lyc}=5\ee{45}$ \pers \citep{Vacca1996a}.
The upper limits on the presence of such an \hii region are constraining,
with $R<100 AU$, which is consistent with the presence of these stars.

variability -> Stellar bloating \citep{Smith2012h, Hosokawa2016a}
...
{The e2e core as seen in the \methanol \todo{10?xx} line with
