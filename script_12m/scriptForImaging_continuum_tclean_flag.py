...
mergevis='w51_spw3_continuum_flagged.split'
if not os.path.exists(mergevis):
    raise ValueError("Missing vis!")

extensions = ['.flux', '.image', '.mask', '.model', '.pbcor', '.psf',
              '.residual', '.flux.pbcoverage', '.sumwt', '.weight', '.pb',
              '.pbcoverage']

contimagename = 'w51_spw3_continuum_flagged_tclean'
...
contimagename = 'w51_spw3_continuum_flagged_r0_tclean'
...
contimagename = 'w51_spw3_continuum_flagged_r0_dirty_tclean'
...
contimagename = 'w51_spw3_continuum_flagged_r0_multiscale_tclean'
...
contimagename = 'w51_spw3_continuum_flagged_r0_MEM_tclean'
...
contimagename = 'w51_spw3_continuum_flagged_uniform_tclean'
