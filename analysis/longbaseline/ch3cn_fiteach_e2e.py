...
if os.path.exists('e2e_CH3CN_Absorption_fits.fits'):
    pcube_cont.load_model_fit('e2e_CH3CN_Absorption_fits.fits', npars=5)
else:
    min_background = 100
...
extracted_disky_width = pvextractor.extract_pv_slice(np.abs(pcube_cont.parcube[1:2,:,:]),
                                                     diskypath,
                                                     wcs=pcube_cont.wcs)
...
pl.savefig(paths.fpath("longbaseline/kinematics/velocity_vs_offset_withwidth.png"))
