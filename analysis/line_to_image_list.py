...
labeldict = {
               'CH3SH_152-151': 'CH$_3$SH $15_2-15_1$',
               'CH3SH_162-161': 'CH$_3$SH $16_2-16_1$',
               'CH3SH_73-82': 'CH$_3$SH $7_3-8_2$',
               'CH3SH_232-231': 'CH$_3$SH $23_2-23_1$',
               'CH3NCO_25223-24222': 'CH$_3$NCO $25_{2,23} - 24_{2,22}$',
               'CH3NCO_25124-24123': 'CH$_3$NCO $25_{1,24} - 24_{1,23}$',
               'CH3NCO_27226-26225': 'CH$_3$NCO $27_{2,26} - 26_{2,25}$',
               'g-CH3CH2OH_13211-12210': 'g-CH$_3$CH$_2$OH $13_{2,11}-12_{2,10}$', # ethanol
               ...
               'CH3OH422-312':  'E-CH$_3$OH $4_{2,2}-3_{1,2}$',
               'CH3OH423-514':  'A-CH$_3$OH $4_{2,3}-5_{1,4}$',
               'CH3OH5m42-6m34': 'E-CH$_3$OH $5_{-4,2}-6_{-3,4}$',
               'CH3OH5m42-6m43': 'E-CH$_3$OH $5_{-4,2}-6_{-3,4}$', # this one is a typo
               'CH3OH808-716': 'E-CH$_3$OH $8_{0,8}-7_{1,6}$',
               'CH3OH1029-936': 'A-CH$_3$OH $10_{2,9}-9_{3,6}$',
               'CH3OH1028-937': 'A-CH$_3$OH $10_{2,8}-9_{3,7}$',
               'CH3OHvt=01028-937++': 'A-CH$_3$OH $10_{2,8}-9_{3,7}$',
               'CH3OH18315-17414': 'A-CH$_3$OH $18_{3,15}-17_{4,14}$',
               'CH3OH_10m38-11m210': 'E-CH$_3$OH $10_{-3,8}-11_{-2,10}$',
               'CH3OH_18316-17413': 'A-CH$_3$OH $18_{3,16}-17_{4,13}$',
               'CH3OH25322-24420': 'E-CH$_3$OH $25_{3,22}-24_{4,20}$',
               'CH3OH23519-22617': 'E-CH$_3$OH $23_{5,19}-22_{6,17}$',
               ...
               'Acetone871-744AE':'Acetone $8_{7,1}-7_{4,4}$AE',
               'Acetone1294-1183EE':'Acetone $12_{9,4}-11_{8,3}$EE',
               'Acetone12112-11101AE':'Acetone $12_{11,2}-11_{10,1}$AE',
               ...
               '12CO2-1': '$^{12}$CO $2-1$',
               'PN5-4': 'PN $5-4$',
               'SO2_22715-23618': 'SO$_2$ $22_{7,15}-23_{6,18}$',
               'SO2_16610-17513': 'SO$_2$ $16_{6,10}-17_{5,13}$',
               'SO2v2=1_20218-19317': 'SO$_2$ $v_2=1$ $20_{2,18}-19_{3,17}$',
               'SO2v2=1_22220-22121': 'SO$_2$ $v_2=1$ $22_{2,20}-22_{1,21}$',
               'SO2v2=1_16313-16214': 'SO$_2$ $v_2=1$ $16_{3,13}-16_{2,14}$',
               'SO2v2=1_642-735': 'SO$_2$ $v_2=1$ $6_{4,2}-7_{3,5}$',
}
