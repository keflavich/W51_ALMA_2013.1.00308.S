...
myimagebase = "merge_selfcal_spw3_selfcal_4ampphase_mfs_tclean_deeperbroader"
os.system('rm -rf {0}.*'.format(myimagebase))
tclean(vis=vis4, imagename=myimagebase, field="", spw="", specmode='mfs',
       deconvolver='multiscale', gridder='mosaic', outframe='LSRK',
       scales=multiscale,
...
sigma, peak = (fits.getdata('merge_selfcal_spw3_dirty.residual.fits')[slc].std(),     np.nanmax(fits.getdata('merge_selfcal_spw3_dirty.residual.fits')))
